...
const todos = [
    {
        ...
        description: "เรียนการเขียนโปรแกรมเว็บด้วย React Node.js and Firebase",
        cover: "/images/blog_1645521800.png",
    ...
    },
    {
        ...
        description: "เรียนการเขียนโปรแกรมมิ่งด้วย javascript",
        cover: "/images/shutterstock_1680857539.jpg",
        icon:"/images/12223.jpg",
        enrollment: false,
        checked: false
    },
    {
        ...
        description: "เรียนเกี่ยวกับการเขียนโปรแกรมซอฟแวร์ ด้วยการพัฒนาซอฟแวร์ ซอฟแวร์ประยุกต์",
        cover: "/images/qr-23.jpg",
        icon:"/images/12222.jpg",
        enrollment: false,
        checked: false
    }
];
  ...
  <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    ...
    <div className="flex items-center">
      ...
      <div className="text-sm">
        <p className="text-gray-900 leading-none">kaiwichkorn ketbuppha</p>
